...
```{r}
# Method 1 for 1966 version: use the Return.excess function from PerformanceAnalytics, 
...
# Method 2 for 1994 version: use the built in SharpeRatio function in PerformanceAnalytics.
